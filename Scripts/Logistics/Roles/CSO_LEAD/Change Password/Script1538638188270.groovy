...
WebUI.click(findTestObject('Page_MyEG Services  Logistic Report/a_Change Password'))

WebUI.setEncryptedText(findTestObject('Page_MyEG Services  Logistic Report/input_old_password'), 'aeHFOx8jV/A=')

WebUI.setEncryptedText(findTestObject('Page_MyEG Services  Logistic Report/input_new_password'), 'RigbBhfdqOBGNlJIWM1ClA==')

WebUI.setEncryptedText(findTestObject('Page_MyEG Services  Logistic Report/input_renew_password'), 'RigbBhfdqOBGNlJIWM1ClA==')
...
WebUI.setEncryptedText(findTestObject('Page_MyEG Services  Logistic Report/input_new_password'), 'sJQMLUReLOqSQR8WiRUVuA==')

WebUI.setEncryptedText(findTestObject('Page_MyEG Services  Logistic Report/input_renew_password'), 'sJQMLUReLOqSQR8WiRUVuA==')
