...
WebUI.setEncryptedText(findTestObject('Page_MyEG Services  Logistic Report/input_new_password'), 'aeHFOx8jV/A=')

WebUI.setEncryptedText(findTestObject('Page_MyEG Services  Logistic Report/input_renew_password'), 'aeHFOx8jV/A=')
